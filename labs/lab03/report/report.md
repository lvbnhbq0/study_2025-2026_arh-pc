...
![Подготовка отчёта](image/7.png){#fig:007 width=70%}

Дополнительно: в ходе работы мне было необходимо установить tinytex, что я и делаю (рис. -@fig:009)
![Установка tinytex](image/9.png){#fig:009 width=70%}
...
![Выполнение отчета по 2 лабораторной работе](image/8.png){#fig:008 width=70%}
